...
# Merge counts with summary table
...
# Sort the summary table by 'hours_delayed' column in descending order
...
#| code-summary: Read and format data
# Include and execute your code here
# Filter out rows with missing Month variable
flights_filtered = flights.dropna(subset=['month'])

# Group by month and calculate average delay time
average_delay_per_month = flights_filtered.groupby('month')['hours_delayed'].mean().reset_index()

# Plot the average delay time for each month using Plotly Express
